...
public class CliDriver {
  ...
  // wai，B+树索引
//  public static File dbFile = new File("data\\testDB1");
//  public static DB db = DBMaker.newFileDB(dbFile).closeOnJvmShutdown()
//      .encryptionEnable("password").make();
//  // open an collection, TreeMap has better performance then HashMap
//  public static BTreeMap<Long, String> bTreeMap = db.getTreeMap("bTree");
